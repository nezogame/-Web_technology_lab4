...
<section > 
    ...
    <div>            
            <div class="header">
            <a href ="http://localhost/lab4" class="logo">
            <img src="source\logo-removebg.png"  
                ...
                <div class="panel">
                    ...
                    <a href="http://localhost/Lab4/acquire.php">
                    <div class="circle" onclick="location.href=''"> Contact</div>
                    </a >
                    <a href="http://localhost/Lab4/buy.php">
                    <div class="circle" >
            ...
            <div class="nav_menu_block">
                <ul class = "horizontal-list">
                    <li>
                        <a class="nav-link" href ="http://localhost/lab4">Каталог</a>
                    </li>
                    <li>
                        <a class="nav-link" href ="http://localhost/lab4/discount.php">Акії</a>
                    </li>
                    <li>
                        <a class="nav-link" href ="http://localhost/lab4/blubs.php">Цибулини</a>
                    </li>
                    <li>                        
                        <a class="nav-link" href ="http://localhost/lab4/perennial.php">Багаторічні</a>
                    </li>
                    <li>                        
                        <a class="nav-link" href ="http://localhost/lab4/berries.php">Ягідні</a>
                    </li>
                    <li>                        
                        <a class="nav-link" href ="http://localhost/lab4/сonifers.php">Хвойні</a>
                    </li>
                    <li>                        
                        <a class="nav-link" href ="http://localhost/lab4/annual.php">Однорічні</a>
                    </li>
                </ul>
            </div>
    </div> 
    <form class="reg_form">
            <div class="registration-popup">
              ...
              <div class="input-row">
                ...
                <span class="error error_email">Please Enter Your Email</span>
              </div>
              <div class="input-row">
                <input type="tel" class="textarea" id="phone" placeholder="Phone*">
                <span class="error error_phone">Please Enter Your Phone</span>
              </div>
        ...
        <form class="login_form">
            <div class="login_popup">
              ...
              <div class="input-row">
                <input class="textarea" name="login_name" placeholder="Name*">
                <span class="error log_error_name">Please Enter Your Name</span>
              </div>
              <div class="input-row">
                <input class="textarea" name="login_email" placeholder="Email*">
                <span class="error log_error_email">Please Enter Your Email</span>
              </div>
              <div class="button_wraper">
